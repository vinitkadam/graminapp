...
import SamitiMemberItem from './components/SamitiMemberItem'
...
class GPSamiti extends Component {
    render() {
        return (
            <Container style={{ marginTop: StatusBar.currentHeight}}>
                <Header2 title='Gram Panchayat Samiti' navigationProps={this.props.navigation} />
                <Content>
                    <FlatList
                        data = {dummydata}
